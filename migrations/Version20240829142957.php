 ...
 */
final class Version20240829142957 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE bet ADD user_id INT NOT NULL, ADD league_event_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE bet DROP user_id, DROP league_event_id');
    }
}
